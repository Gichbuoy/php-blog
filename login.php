...
<head>
    ...
    <title> Sips & Stories - Login</title>
 ...
 <script type="text/javascript">
			   ...
			   $("#login").click(function(){
					...
					password=$("#password").val();
					 $.ajax({
						type: "POST",
						url: "pcheck.php", //pcheck page checks email and password and return a true or false code
						...
						success: function(html){
						  if(html=='true')
						  {
							...
							window.location.href = "blog.php";   // when user is authenticated, they are redirected to blog page
